...
namespace gml
{
	...
	public:
		...
		inline static const vec2& left()
		{
			static vec2 v(-1.0f, 0.0f);
			return v;
		}
		inline static const vec2& right()
		{
			static vec2 v(1.0f, 0.0f);
			return v;
		}
		inline static const vec2& up()
		{
			static vec2 v(0.0f, 1.0f);
			return v;
		}
		inline static const vec2& down()
		{
			static vec2 v(0.0f, -1.0f);
			return v;
		}
	...
	public:
		...
		friend inline vec2& operator+=(vec2& lhs, float rhs)
		{
			return (lhs = lhs + rhs);
		}
		...
		friend inline vec2& operator+=(vec2& lhs, const vec2& rhs)
		{
			return (lhs = lhs + rhs);
		}
...
namespace gml
{
	...
	public:
		...
		inline static const vec3& left()
		{
			static vec3 v(-1.0f, 0.0f, 0.0f);
			return v;
		}
		inline static const vec3& right()
		{
			static vec3 v(1.0f, 0.0f, 0.0f);
			return v;
		}
		inline static const vec3& up()
		{
			static vec3 v(0.0f, 1.0f, 0.0f);
			return v;
		}
		inline static const vec3& down()
		{
			static vec3 v(0.0f, -1.0f, 0.0f);
			return v;
		}
		inline static const vec3& forward()
		{
			static vec3 v(0.0f, 0.0f, 1.0f);
			return v;
		}
		inline static const vec3& backward()
		{
			static vec3 v(0.0f, 0.0f, -1.0f);
			return v;
		}
	...
	public:
		...
		friend inline vec3& operator+=(vec3& lhs, float rhs)
		{
			return (lhs = lhs + rhs);
		}
		...
		inline void set(const vec2& v2, float _z)
		{
			set(v2.x, v2.y, _z);
		}
		...
		inline void replace(const vec2& v2)
		{
			x = v2.x;
			y = v2.y;
		}
...
namespace gml
{
	...
	public:
		...
		friend constexpr bool operator==(const vec4& lhs, const vec4& rhs)
		{
			return &lhs == &rhs ||
				(fequal(lhs.x, rhs.x) &&
					fequal(lhs.y, rhs.y) &&
		...
		inline void set(const vec2& v2, float _z, float _w)
		{
			set(v2.x, v2.y, _z, _w);
		}

		inline void set(const vec3& v3, float _w)
		{
		...
		inline void replace(const vec3& v3)
		{
