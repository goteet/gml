...
public:
	...
	TEST_METHOD(Vector3NegativeTest)
	{
		// operator-
	...
	TEST_METHOD(Vector3CompareTest)
	{
	...
	TEST_METHOD(Vector3ReplaceTest)
	{
		vec3 v1(1.0f, 2.0f, 3.0f);
		vec2 vv(0.0f, 0.0f);
	...
	// inverse
	// inversed
	TEST_METHOD(Vector3InverseTest)
	{
		vec3 v1(1.0f, 0.0f, 0.0f);
		auto a = v1.inversed();
		v1.inverse();
	...
	TEST_METHOD(Vector3CombineTest)
	{
		vec3 v1(1.0f, 2.0f, 3.0f);
		vec3 v2(3.0f, 0.0f, 2.0f);
